...
✍️ To view the emojis I can use, simply type /reactions. To create your own auto reaction bot, head over to: [Auto-Reaction-Bot on GitHub](https://github.com/usdtqbot/rugerreactbot).
...
<button class="button githubBtn" onclick="window.location='https://github.com/usdtqbot/rugerreactbot'">Open Source 🌱</button>

<div style="margin: 5px;">
  <a class="github-button" href="https://github.com/usdtqbot/rugerreactbot" data-size="large" data-show-count="true">Star</a>
  <a class="github-button" href="https://github.com/usdtqbot/rugerreactbot/fork" data-size="large" data-show-count="true">Fork</a>
</div>
<div>
  <a class="github-button" href="https://github.com/usdtqbot" data-size="large">Follow @usdtqbot</a>
</div>
</body>
</html>
`;
